...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t border-border bg-background-surface/50 p-4 sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    >
...
function DialogTitle({ className, ...props }) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-heading text-base leading-none font-medium text-text-primary",
        className,
      )}
      {...props}
    />
...
function DialogDescription({ className, ...props }) {
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        "text-sm text-text-tertiary *:[a]:underline *:[a]:underline-offset-3 *:[a]:hover:text-text-primary",
        className,
      )}
      {...props}
    />
